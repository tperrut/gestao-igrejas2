    ...
    <section className="py-16 bg-church-red text-white">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-xl mb-8 max-w-2xl mx-auto">
          Junte-se a centenas de igrejas que estão usando a <span className="font-bold text-yellow-200">Plataforma BetelHub</span> para simplificar sua administração.
        </p>
